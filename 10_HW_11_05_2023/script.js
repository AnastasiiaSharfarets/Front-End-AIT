...
//account holder name, and balance. Add methods for depositing
//and withdrawing money from the account, and a method for checking the balance.
...
const bankAccount = {
  ...
  checkBalance: function () {
      alert(`Account balance is ${this.balance}`)
  },
};
...
// Но при этом формат независим от JS и может использоваться в любом языке программирования. JSON используется в REST API.
